...
const Product = ({ product }) => {
  ...
  return (
    <div>
      <div className='border border-[#e4e4] h-[300px] mb-4 relative overflow-hidden group transition'>
        ...
        <div className='absolute top-3 right-8 group-hover:right-4 p-2 flex flex-col items-center justify-center gap-y-2 opacity-0 group-hover:opacity-100 transition-all duration-300'>
          ...
          <Link
            to={`/product/${id}`} 
            className='w-12 h-12 bg-yellow-500 flex justify-center items-center text-black drop-shadow-xl'
          >
            <BsEyeFill />
          </Link>
        </div>
