  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('.\public\assets\images\login3.jpg')",
          backgroundSize: 'cover',
        }}
      >
        <div className="bg-transparent p-8 rounded-lg shadow-md w-96 transform transition-transform duration-200 hover:shadow-lg ml-40">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="off"
                name="password"
                className="w-full text-black px-3 py-2 rounded border-2 border-black-500 focus:outline-none focus:border-yellow-300 hover:scale-105"
                value={password}
